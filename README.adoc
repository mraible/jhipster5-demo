...
JHipster 5 is the same JHipster many developers know and love, with a couple bright and shiny new features: namely React, Angular 6, and Spring Boot 2 support.
...
You can further enhanced the security of your API by only allowing users that own a blog or entry to edit it.
...
Below is the refactored `BlogResource.java` after everything has been locked down.
...
You'll need to make similar changes in `EntryResource.java`. See https://github.com/mraible/jhipster5-demo/commit/9694891f98c4c1076ee636664f2cb0f6cd7986f0[this commit] for all the changes that you'll need in to these two classes, as well as their integration tests.
...
**Matt Raible** is a web developer and Java Champion. He loves to architect and build slick-looking UIs with CSS and TypeScript. When he's not evangelizing https://okta.com[Okta] and open source, he likes to ski with his family, drive his VWs, and enjoy craft beer.
