...
This article shows you how to build a simple blog application with https://www.jhipster.tech/2018/06/23/jhipster-release-5.0.1.html[JHipster 5.0.1]. You can also [watch a video of this tutorial on YouTube](https://www.youtube.com/watch?v=-VQ_SVkaXbs).
